...
const Dashboard: React.FC<DashboardProps> = ({
  ...
  const stats = [
    ...
    },
    {
      ...
      value: totalArmaFogo,
      icon: 'fa-gun',
      color: totalArmaFogo > 0 ? 'bg-emerald-600/20' : 'bg-slate-900/20',
      textColor: totalArmaFogo > 0 ? 'text-emerald-500' : 'text-slate-500',
      borderColor: totalArmaFogo > 0 ? 'border-emerald-600' : 'border-slate-800',
